...
static constexpr std::array<const char*, 13> locations_array__ =
  ...
  " (in 'include/estimator/estimator.stan', line 15, column 2 to column 21)",
  ...
  " (in 'include/estimator/estimator.stan', line 15, column 9 to column 14)"};
 ...
 public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      auto pars =
        in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(Npars);
      {
