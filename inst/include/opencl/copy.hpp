...
#include <opencl/buffer_types.hpp>
#include <opencl/kernel_cl.hpp>
...
#include <opencl/kernels/pack.hpp>
#include <opencl/kernels/unpack.hpp>
#include <opencl/err/check_opencl.hpp>
#include <opencl/err/check_triangular.hpp>
