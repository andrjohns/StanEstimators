...
#include <opencl/kernels/diag_inv.hpp>
#include <opencl/kernels/inv_lower_tri_multiply.hpp>
#include <opencl/kernels/neg_rect_lower_tri_multiply.hpp>
#include <opencl/err.hpp>
#include <opencl/kernels/batch_identity.hpp>
