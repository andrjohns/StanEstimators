...
#include <opencl/kernel_generator/operation_cl.hpp>
#include <opencl/kernel_generator/operation_cl_lhs.hpp>
#include <opencl/kernel_generator/as_operation_cl.hpp>
#include <opencl/kernel_generator/name_generator.hpp>
#include <opencl/kernel_generator/type_str.hpp>

#include <opencl/kernel_generator/as_column_vector_or_scalar.hpp>
#include <opencl/kernel_generator/load.hpp>
#include <opencl/kernel_generator/scalar.hpp>
#include <opencl/kernel_generator/constant.hpp>
#include <opencl/kernel_generator/append.hpp>
#include <opencl/kernel_generator/binary_operation.hpp>
#include <opencl/kernel_generator/elt_function_cl.hpp>
#include <opencl/kernel_generator/unary_operation_cl.hpp>
#include <opencl/kernel_generator/block_zero_based.hpp>
#include <opencl/kernel_generator/select.hpp>
#include <opencl/kernel_generator/rowwise_reduction.hpp>
#include <opencl/kernel_generator/colwise_reduction.hpp>
#include <opencl/kernel_generator/reduction_2d.hpp>
#include <opencl/kernel_generator/transpose.hpp>
#include <opencl/kernel_generator/broadcast.hpp>
#include <opencl/kernel_generator/optional_broadcast.hpp>
#include <opencl/kernel_generator/diagonal.hpp>
#include <opencl/kernel_generator/holder_cl.hpp>
#include <opencl/kernel_generator/check_cl.hpp>
#include <opencl/kernel_generator/index.hpp>
#include <opencl/kernel_generator/indexing.hpp>
#include <opencl/kernel_generator/opencl_code.hpp>
#include <opencl/kernel_generator/cast.hpp>

#include <opencl/kernel_generator/multi_result_kernel.hpp>
#include <opencl/kernel_generator/get_kernel_source_for_evaluating_into.hpp>
#include <opencl/kernel_generator/evaluate_into.hpp>

#include <opencl/kernel_generator/matrix_cl_conversion.hpp>
#include <opencl/kernel_generator/compound_assignments.hpp>

#include <opencl/kernel_generator/matrix_vector_multiply.hpp>
