...
Full MCMC estimation is provided by the
[`stan_sample()`](https://andrjohns.github.io/StanEstimators/reference/stan_sample.md)
function, which uses Stan’s default No U-Turn Sampler (NUTS) unless
otherwise specified:
