...
#>  1 lp__     -39.7    -39.6    2.67  2.69  -44.4   -35.6  1.00      281.     529.
#>  2 pars[1]    7.76     7.84   5.17  4.90   -0.438  15.6  1.000     487.     354.
#>  3 pars[2]    6.48     5.00   5.91  4.67    0.537  17.8  1.00      403.     466.
#>  4 pars[3]    0.325    0.374  0.942 0.899  -1.25    1.73 1.00     1083.     633.
#>  5 pars[4]   -0.0202  -0.0130 0.873 0.880  -1.47    1.33 1.01     1043.     625.
#>  6 pars[5]   -0.121   -0.134  0.968 0.893  -1.72    1.49 1.00      997.     496.
#>  7 pars[6]   -0.0348  -0.0406 0.872 0.865  -1.43    1.40 1.00      839.     670.
#>  8 pars[7]   -0.410   -0.402  0.915 0.885  -1.90    1.11 1.00      987.     603.
#>  9 pars[8]   -0.236   -0.256  0.893 0.855  -1.69    1.21 1.00     1217.     699.
#> 10 pars[9]    0.294    0.307  0.962 0.951  -1.34    1.85 0.999     782.     515.
#> 11 pars[10]   0.0546   0.0615 0.867 0.854  -1.39    1.50 0.999    1145.     595.
```
...
#>                           Count Pct.    Min. ESS
#> (-Inf, 0.67]   (good)     3     37.5%   357     
#>    (0.67, 1]   (bad)      4     50.0%   <NA>    
#>     (1, Inf)   (very bad) 1     12.5%   <NA>    
